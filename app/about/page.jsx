      ...
      <main className="flex-1 flex flex-col w-full">
        ...
        <section className="relative w-full h-[100vh] flex items-center justify-center overflow-hidden">
          ...
          <div
            ...
            style={{ backgroundImage: `url('/backgrounds/9a5b333b-3981-4d6a-a235-7e91fc1c6ff8.jpg')` }}
          />
          ...
          >
            <div className="font-mono text-sm font-black uppercase tracking-[0.4em] text-lime-400/80 mb-6 drop-shadow-[0_0_10px_rgba(163,230,53,0.5)]">KMHQ Organization</div>
            ...
            <p className="mx-auto max-w-3xl text-xl md:text-2xl leading-relaxed text-white/80 font-light">
              A premier Star Citizen organization dedicated to excellence across all sectors.
              We operate with precision, coordination, and overwhelming force.
            </p>
          </motion.div>
        ...
        <section className="relative w-full py-32 px-6 bg-[#020402]">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tight text-white mb-4">Our <span className="text-lime-400">Divisions</span></h2>
              <div className="w-24 h-1 bg-lime-400/30 mx-auto rounded-full" />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: "Security & Combat", icon: Shield, desc: "Elite combat wings specialized in escort, defense, and aggressive negotiations. We ensure the safety of our operations across the verse." },
                { title: "Logistics & Trade", icon: Target, desc: "The backbone of our operations, moving high-value assets securely across systems. Our trade networks are unmatched." },
                { title: "Deep Exploration", icon: Crosshair, desc: "Charting unknown territories and securing valuable intelligence and resources before they hit the open market." }
              ].map((item, idx) => (
                <motion.div
                  key={item.title}
        ...
        <section className="relative w-full py-40 flex items-center justify-center overflow-hidden">
          <div
            className="absolute inset-0 z-0 bg-cover bg-center bg-fixed"
            style={{ backgroundImage: `url('/backgrounds/SC-4.5.0_20251229_131102_Hathor-orbital-laser_f.png')` }}
          />
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/70 leading-relaxed mb-8">
                Our fleet is a testament to our ambition. From agile light fighters to capital-class dreadnoughts, KMHQ possesses the logistical and combative capabilities to tackle any objective, anywhere in the galaxy.
              </p>
            ...
            >
              <img src="/backgrounds/SC-4.4.0_20251214_152954_Wolf-Yela-rings_f.png" alt="Fleet in action" className="absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
              <div className="absolute bottom-8 left-8 right-8">
                <div className="text-lime-400 font-mono text-xs uppercase tracking-[0.3em] mb-2">Operation: Zenith</div>
                <div className="text-white font-bold text-xl uppercase tracking-wide">Deep Space Deployment</div>
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-white/60 leading-relaxed max-w-4xl mx-auto">
                Founded by a core group of veteran pilots, Makhlooq has grown from a specialized strike team into a multi-system powerhouse. We believe in quality over quantity, ensuring every member of our organization represents the pinnacle of skill and dedication.
              </p>
            </motion.div>
          </div>
        </section>
